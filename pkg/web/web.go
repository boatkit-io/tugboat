// Package web exports various types to support an HTTP server.
package web
...
func Respond(log *logrus.Logger, w http.ResponseWriter, r *http.Request, code int, data interface{}, errs ...error) {
	...
	writeResponse(log, w, r, code, &resp)
}
...
func writeResponse(log *logrus.Logger, w http.ResponseWriter, r *http.Request, code int, resp *Response) {
	...
	if err != nil {
		RespondError(log, w, r, http.StatusInternalServerError, err)
		return
	}
