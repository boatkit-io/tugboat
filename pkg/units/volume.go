...
func (u Volume) Convert(newUnit VolumeUnit) Volume {
	v2 := convertTableUnit(volumeConversions, u.Value, u.Unit, newUnit)
	return NewVolume(newUnit, v2)
}

// Add will add another unit to this one, returning a new unit with the added values
func (u Volume) Add(o Volume) Volume {
	v2, u2 := addTableUnits(volumeConversions, u.Value, u.Unit, o.Value, o.Unit)
	return NewVolume(u2, v2)
}

// Sub will subtract another unit from this one, returning a new unit with the subtracted values
func (u Volume) Sub(o Volume) Volume {
	v2, u2 := subTableUnits(volumeConversions, u.Value, u.Unit, o.Value, o.Unit)
	return NewVolume(u2, v2)
}
